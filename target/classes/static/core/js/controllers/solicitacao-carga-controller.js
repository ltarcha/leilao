app.controller('SolicitacaoCargaController', ['SolicitaoCargaService', 'LocalidadeService', 'ArmazemService', 'TipoVeiculoService', 'ParticularidadeService', 'alertify', '$http','$filter', '$location', '$window', '$scope',
                                     function(SolicitaoCargaService, LocalidadeService, ArmazemService, TipoVeiculoService, ParticularidadeService, alertify, $http, $filter, $location, $window, $scope){
	...
	self.save = function() {
		SolicitaoCargaService.save(self.solcarga).then(function(resp){
			self.solcarga = resp.data;
